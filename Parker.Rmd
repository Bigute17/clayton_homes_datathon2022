...
VIRegion_VITime_Joined <- VIRegion_VITime_Joined %>% filter(Year >= 2011) ## Took off Years below 2011 because of Mortages limit
...
VIRegion_VITime_Joined_RI_ZIP <- full_join(VIRegion_VITime_Joined, ZIP_CODE_RI, by = "RegionID")
HOUSE_WITH_EVERYTHING <- full_join(VIRegion_VITime_Joined_RI_ZIP, Zip, by = c("Year","RegionName" = "Zip_Code")) 
```
